      ...
      >
        <div className="relative">
          ...
          <AnimatePresence>
            {showTooltip && (
              <motion.div
                ...
                exit={{ opacity: 0, x: 10 }}
                className="absolute right-full mr-4 top-1/2 -translate-y-1/2 bg-amazon-dark text-white px-4 py-2 rounded-xl whitespace-nowrap shadow-xl border border-white/10"
              >
          ...
          <motion.button
            ...
            className="relative bg-gradient-to-br from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 text-white p-4 rounded-2xl shadow-2xl shadow-primary-500/30 transition-all duration-300 group border-2 border-white/20"
